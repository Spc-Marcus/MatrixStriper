...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_col_quality", type=int, default=2, help="Qualité minimale des colonnes.")
    parser.add_argument("--min_row_quality", type=int, default=3, help="Qualité minimale des lignes.")
